...
window.App = {
  ...
  parseUrlParams: function () {
    ...
    if (mode === "guess" || mode === "judge") {
      StorageUtil.saveMode(
        mode === "judge"
          ? window.Constants.MODES.JUDGE
          : window.Constants.MODES.NOTE,
      );
    }
    ...
    if (feedbackSet === "default" || feedbackSet === "custom") {
      StorageUtil.saveFeedbackPreset(
        feedbackSet === "custom" ? "CUSTOM" : "DEFAULT",
      );
    }
  ...
  // 配置更新回调
  onConfigChange: function (_config) {
