...
window.ConfigComponent = {
  ...
  loadConfig: function () {
    ...
    document.getElementById("feedbackPreset").value =
      config.feedbackPreset || window.Constants.DEFAULT_FEEDBACK_PRESET;
  },
  ...
  updateConfig: function () {
    const config = {
      answerLength:
        parseInt(document.getElementById("answerLength").value) || 5,
      minGuessLength:
        parseInt(document.getElementById("minGuessLength").value) || 4,
      maxGuessLength:
        parseInt(document.getElementById("maxGuessLength").value) || 10,
      feedbackPreset:
        document.getElementById("feedbackPreset").value ||
        window.Constants.DEFAULT_FEEDBACK_PRESET,
    };
